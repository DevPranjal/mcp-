---
title: "SEP-1: MCP Skills - Progressive Disclosure for Servers via Resources"
sidebarTitle: "SEP-1: MCP Skills - Progressive Disclosure for…"
description: "MCP Skills - Progressive Disclosure for Servers via Resources"
---
...
| ------------- | ------------------------------------------------------------------------- |
| **SEP**       | 1                                                                         |
| **Title**     | MCP Skills - Progressive Disclosure for Servers via Resources             |
| **Status**    | Draft                                                                     |
| **Type**      | Standards Track                                                           |
| **Created**   | 2026-05-03                                                                |
| **Author(s)** | [@DevPranjal](https://github.com/DevPranjal)                              |
| **Sponsor**   | None (seeking sponsor)                                                    |
| **PR**        | [#1](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/1) |
